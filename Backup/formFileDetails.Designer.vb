...
Partial Class formFileDetails
	...
	Private Sub InitializeComponent()
		...
		'
		Me.TranscriptionFileClassBindingSource.DataSource = GetType(WinREG.TranscriptionFileClass)
		'
		'ChurchComboBox
		'
		...
		Me.RecordTypesBindingSource.DataSource = GetType(WinREG.LookupTables)
		'
