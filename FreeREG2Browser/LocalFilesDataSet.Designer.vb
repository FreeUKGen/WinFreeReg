...
Partial Public Class LocalFilesDataSet
    ...
    Partial Public Class LocalFileDataTable
      ...
      Public Overloads Function AddLocalFileRow( _
                    ...
                    ByVal RecordType As String) As LocalFileRow
         Dim rowLocalFileRow As LocalFileRow = CType(Me.NewRow, LocalFileRow)
         Dim columnValuesArray() As Object = New Object() {Name, Length, DirectoryName, Directory, IsReadOnly, Exists, FullName, Extension, CreationTime, CreationTimeUtc, LastAccessTime, LastAccessTimeUtc, LastWriteTime, LastWriteTimeUtc, Attributes, LastUploadTime, Place, Church, RecordType}
