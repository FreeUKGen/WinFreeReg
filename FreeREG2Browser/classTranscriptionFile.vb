...
Public Class TranscriptionFileClass
	...
	Private m_FreeregTables As WinREG.FreeregTables
	Public Property FreeregTables() As WinREG.FreeregTables
		Get
	...
	Private Sub AddNewBaptismRecord(ByRef recordcollection As WinREG.TranscriptionTables.BaptismsDataTable, ByVal rec As String())
	...
	Private Sub AddNewBurialRecord(ByRef recordcollection As WinREG.TranscriptionTables.BurialsDataTable, ByVal rec As String())
	...
	Private Sub AddNewMarriageRecord(ByRef recordcollection As WinREG.TranscriptionTables.MarriagesDataTable, ByVal rec As String())
